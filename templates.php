...
<div class="row row-b row-countdown font-gothic" ng-controller="clockCtrl">
    ...
    <div class="contest-description text-shadow-dark">
        ...
        <p class="text-shadow-light-blue"><?php echo "the competition runs from star date 01/04/2014 to 31/07/2014 at that point we'll go through all of the entries and the one that we feel has given us the best reason to go will be picked as our intergalactic hero."; ?></p>
...
<div class="row row-b row-footer font-gothic text-shadow-soft">
    ...
    <div class="description">
        ...
        <p>t's and c's apply. please read full terms <a class="here" href="" ng-click="navigateTo('terms-and-conditions')">here</a>. the winners face represented on a 3d model will be sent on a<br/> weather balloon to the edge of space. competition runs until 16:00 gmt 31/07/2014. you must be over 16 years to enter.<br/> no purchase necessary. you must be a uk resident.</p>
